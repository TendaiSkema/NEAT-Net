...
class GraphNet:
    ...
    def forward(self, X, iterations=2):
        ...
        output = state[self.input_size + self.hidden_size:, :].T # extract output (txo) (4x1)
...
if __name__ == "__main__":
    ...
    gn = GraphNet(input_size=2, hidden_size=2, output_size=1)
    gn.set_adjacency(adj)
    
    gn.train(X, Y, epochs=100, iterations=2, backiterations=2, lr=0.1)
